...
echo "insert into service_registry (service_type, service_url, service_urn, service_cert, service_name, service_description) values (0, 'https://www.pgeni3.gpolab.bbn.com:12369/protogeni/xmlrpc/am/2.0', 'urn:publicid:IDN+pgeni3.gpolab.bbn.com+authority+cm', '/usr/share/geni-ch/sr/certs/pgeni3.pem', 'pgeni3', 'pgeni3 SW test PG AM in GPO');" >> $FILENAME
