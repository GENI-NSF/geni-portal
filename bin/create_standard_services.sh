...
echo "insert into service_registry (service_type, service_url, service_cert) values (1, 'https://$HOSTNAME/sa/sa_controller.php', '${CERT}');" > $FILENAME
...
echo "insert into service_registry (service_type, service_url, service_cert) values (2, 'https://$HOSTNAME/pa/pa_controller.php', '${CERT}');" >> $FILENAME
...
echo "insert into service_registry (service_type, service_url, service_cert) values (3, 'https://$HOSTNAME/ma/ma_controller.php', '${CERT}');" >> $FILENAME
...
echo "insert into service_registry (service_type, service_url, service_cert) values (5, 'https://$HOSTNAME/logging/logging_controller.php', '${CERT}');" >> $FILENAME
...
echo "insert into service_registry (service_type, service_url, service_cert) values (6, 'https://$HOSTNAME/cs/cs_controller.php', '${CERT}');" >> $FILENAME
